...
<div class="carousel-inner margentop">
    <div class="carousel-item active">
        <div class="container">
            <div class="row p-5">
                <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                    <img class="img-fluid" src="https://static.platzi.com/cdn-cgi/image/width=1024,quality=35,format=auto/media/landing-projects/Proyecto-Python-CRUD.png" alt="">
                </div>
                <div class="col-lg-6 mb-0 d-flex align-items-center">
                    <div class="text-align-left align-self-center">
                        <h1 class="txttitulo"><b>CRUD</b></h1>

                        <p class="txtcrud">
                            SI QUIERES CREAR, LEER, ACTUALIZAR O BORRAR DEBERÁS INICIAR SESIÓN O REGISTRARTE!!
                        </p>
                        <h6 class="txtcreated">Created By Marc Gallego Pozo</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                <h1 class="txtqueescrud">¿QUE ES CRUD?</h1>

            </div>
        </div>
        <div class="row ">

            <div class="col-md-6 col-lg-3 pb-5 "><a href="{{ route('register') }}">
